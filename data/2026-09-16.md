...
TL;DR: 提出PunGraph框架，通过检索增强的音义知识图谱提升LLM对双关语的理解能力，并发布WebPun数据集。


<details>
  <summary>Details</summary>
Motivation: 小规模LLM在双关语推理中存在两大缺陷：音系推理能力不足和语义生成不可控，导致替换词与谐音词的语音相似度低、释义偏离词典语义空间。

Method: 基于Unisyn发音词典、IPA表征、G2P增广和WordNet定义构建音义词汇图谱；通过Neo4j存储；设置IPA相似度阈值(异形双关0.6、同形双关0.5)触发图检索增强，将候选词/候选义项作为选项约束LLM在受限空间中推理。

Result: 在SemEval-2017和WebPun(5,730条)上，PunGraph-Qwen-2.5-7B在异形双关任务相对提升57.95%/30.45%；PunGraph-Llama4-Maverick在SemEval异形双关F1达83.41，超越GPT-4o等大模型；Unisyn贡献最大，G2P为补充；主要错误源于候选选项混淆(同形双关占91.5%)。

Conclusion: PunGraph通过结构化音义知识检索有效弥补小模型缺陷，但存在英语依赖、罕见词覆盖不足、候选选择错误率高等局限；未来可拓展至多语言和多模态场景。
...
TL;DR: 针对开源大模型聊天模板中控制令牌（如 `<|im_start|>`、`<|tool_call|>` 等）可被攻击者文本伪造的问题，提出"无名分词"（Nameless Tokenization）方案：通过删除 added-token 映射表，使控制标识符保留但无表面字符串，从而在文本到标识符的接口层面保证不可伪造，且对正常内容无损。


<details>
  <summary>Details</summary>
Motivation: 开源权重 LLM 的聊天模板和分词器被公开，攻击者可在用户消息或检索文档中写入与模板相同的分隔字符串，分词器会将其映射回保留标识符，从而伪造轮次边界、工具结果等。当前推荐的 `split_special_tokens` 标志在 56.6% 的已部署分词器上仍无法阻止此类伪造，因为它遗漏了工具调用和推理相关的标记。现有训练级防御（指令层级、段嵌入等）成本高且非通用保证。

Method: 1. 审计 256 个已部署聊天分词器的控制令牌可伪造性；2. 提出无名分词：序列化分词器→清空 added-token 表→丢弃后处理器→重载，得到内容编码器 Ec，使任意文本 Ec(t)∩C=∅；3. 模板层在占位符切割后直接将保留字符串写为标识符，内容走 Ec；4. 在 5 个模型/5 个分词器家族上对比 strip/mask/escape 三种清洗基线，评估攻击成功率、清洁准确率和分隔符保真度。

Result: 1. 全部 256 个分词器默认可伪造，开启推荐标志后仍 56.6% 可伪造，主要因为工具/推理标记未标为 special；2. 无名分词在清洁数据上 100% 复现标准分词流；3. 分隔符保真度探针上准确率从 8.5% 提升到 59.9%（清洗基线仅 2.2–24.1%）；4. 攻击分解显示：面对裸任务指令时，标识符贡献仅 7.1 点，分隔符外观贡献 30.4 点；但在含"用户消息为数据"系统提示下，伪造工具结果从 33.1% 降至 7.4%，伪造轮次仍能穿透，而移除标识符是阻止它们的关键；5. 与训练级指令-数据分离结合时，攻击成功率最低可至 0%。

Conclusion: 每个广泛部署的聊天分词器都允许攻击者文本命名轮次和工具结果的保留标识符，而作为补救的标志遗漏了超过一半的此类标记。无名分词在文本到标识符接口层面以构造方式关闭该通道，无需枚举攻击字符串，无清洁准确率损失，应成为默认方案。但其保证仅限于该接口，不解决纯文本指令注入，也不适用于接受标识符输入或绕过渲染器的部署。
...
### [75] [SemanticAdv: Generating Adversarial Examples via Attribute-conditional Image Editing](https://arxiv.org/abs/1906.07927)
...
### [76] [Causal neural set filtering for online multi-target tracking](https://arxiv.org/abs/2609.16054)
...
### [77] [Managing Action Preconditions in Neuro-Symbolic RL: Three Placement Strategies for Embodied Agents](https://arxiv.org/abs/2609.16056)
...
### [78] [OmniHarness: Harnessing Generalizable Visual Generation via Symbolic Policy Learning](https://arxiv.org/abs/2609.16057)
...
### [79] [Driver Behavior Estimation at Signalized Intersections Using a Physics-Constrained Decision-Conditioned Autoregressive Transformer](https://arxiv.org/abs/2609.16058)
...
### [80] [HintMiner: Automatic Question Hints Mining From Q&A Web Posts with Language Model via Self-Supervised Learning](https://arxiv.org/abs/2609.16060)
...
### [81] [POSPAN: Position-Constrained Span Masking for Language Model Pre-training](https://arxiv.org/abs/2609.16061)
...
### [83] [Beyond Distribution Matching: Semantics-Consistent Tabular Diffusion with Weak Semantic Priors](https://arxiv.org/abs/2609.16069)
...
### [84] [Schema-Adaptive Action-Conditioned JEPA for Cross-Machine CNC Transfer under Partial Sensor Overlap](https://arxiv.org/abs/2609.16071)
...
### [85] [Pseudo-Label Augmentation for Affect Sensing in Small Collaborative Groups](https://arxiv.org/abs/2609.16077)
...
### [86] [A Decision-Support Audit Protocol for Supervision Drift in Proxy-Labeled Credit-Risk Prediction](https://arxiv.org/abs/2609.16102)
...
### [87] [LLMs as Master Forgers: Generating Synthetic Time Series Data for Manufacturing](https://arxiv.org/abs/2609.16155)
...
### [88] [Efficient Reasoning Distillation: Small Video-Language Models via Synthetic CoT and Difficulty-Aware Fine-Tuning](https://arxiv.org/abs/2609.16255)
...
### [89] [How Good Are Time-Series Foundation Models for Pedestrian Crowd Count Forecasting? A Cross-Dataset Comparative Study](https://arxiv.org/abs/2609.16415)
...
### [90] [Interpreting and Steering LLM Agents for Social Simulations](https://arxiv.org/abs/2609.16436)
...
### [91] [OPD-Aha: From Linguistic Momentum to Visual Reflection in Multimodal On-Policy Distillation](https://arxiv.org/abs/2609.16459)
...
### [92] [Decoder Design Matters for ECG Delineation](https://arxiv.org/abs/2609.16489)
...
### [93] [What Does Layer-Importance Reveal About Transformers and State-Space Models?](https://arxiv.org/abs/2609.16537)
...
### [94] [On the Importance of Gating: Memorization vs. In-Context Learning in State Space Models](https://arxiv.org/abs/2609.16540)
...
### [95] [Right Direction, Wrong Step: Geometric Analysis of Finite-Step Failure in Looped Transformers](https://arxiv.org/abs/2609.16665)
...
### [96] [Continuous-Time Machine Learning: A Unified Mathematical Perspective](https://arxiv.org/abs/2609.16710)
...
### [97] [TAME: Token Attribution and Masking for Emergent misalignment](https://arxiv.org/abs/2609.16754)
...
### [98] [SOTER: A Generative Time-Series Foundation Model for Wearable Human Physiological Signals](https://arxiv.org/abs/2609.16804)
...
### [99] [Verbalizing Subliminal Learning Effects Using Text Optimization](https://arxiv.org/abs/2609.16927)
...
### [100] [Repurposing Deep Limit Order Book Forecasting for Scenario-Conditioned Market Impact Modeling](https://arxiv.org/abs/2609.16930)
...
### [101] [When Confidence Signals Disagree: Local and Global Confidence in Autoregressive Language Models](https://arxiv.org/abs/2609.16933)
...
### [102] [Beyond Token-Local Imitation: Reward-Compatible Temporal Credit Assignment for On-Policy Distillation](https://arxiv.org/abs/2609.16937)
...
### [103] [Distributed JEPA: A Self-Supervised Framework for Energy Forecasting](https://arxiv.org/abs/2609.17029)
...
### [104] [Repurposing Unified Topological Signatures for Graph Representation Learning](https://arxiv.org/abs/2609.17061)
...
### [105] [A unified framework for global and local interpretability using adaptive derivative-ordered random explanation](https://arxiv.org/abs/2609.17171)
...
### [106] [Easy to Catch a Liar, Hard to Clear an Honest One: Language Models Diagnosing a Corrupted Reward Channel from a Verified Record](https://arxiv.org/abs/2609.17226)
*Arman Nik Khah*
...
### [107] [Learning-Guided Planning in Large Dynamic Action Spaces: Budgeted Tree Search for One-to-Many Mobile Charging](https://arxiv.org/abs/2609.17429)
...
### [108] [Coupled Calibration and Learning: Mitigating Teacher Bias in LLM Distillation without Target-Domain Reward Feedback](https://arxiv.org/abs/2609.17474)
...
### [109] [ENCP: Episode-Normalized Conformal Prediction for Vision-and-Language Navigation](https://arxiv.org/abs/2609.17499)
...
### [111] [Adaptive Bayesian Partner Selection for Federated Clinical Centers](https://arxiv.org/abs/2609.16446)
...
### [112] [High-Performance Tensor Formulation of the Viterbi Algorithm for Hidden Semi-Markov Models](https://arxiv.org/abs/2609.16500)
...
### [113] [Structural Negative Transfer in Federated Graph Neural Networks: Diagnosis, Causal Investigation, and the Limits of Divergence-Aware Mitigation](https://arxiv.org/abs/2609.16977)
...
### [114] [Signed p-adic Residual Encodings of Finite-Domain All-Different Systems with a Sudoku Case Study](https://arxiv.org/abs/2609.16063)
*Greg Baker*
...
### [115] [A panoramic aerodynamic performance prediction method for turbomachinery cascades using transformer-enhanced neural operator](https://arxiv.org/abs/2609.16066)
...
### [116] [A Dynamic Aggregation Strategy Enhanced Efficient Global Optimization Algorithm for Solving High-Dimensional Turbomachinery Design Problems](https://arxiv.org/abs/2609.16067)
...
### [117] [Distilling Foundation Models for Agentic What-If Reasoning:Cost, Latency, and Governance in a Hybrid LLM+SLM Architecture](https://arxiv.org/abs/2609.16091)
...
### [118] [Evaluating Open-Weight E-Commerce Agents with Environment-Grounded Verification](https://arxiv.org/abs/2609.16093)
...
### [141] [FlowATC: Aircraft Trajectory Prediction via Flow Matching](https://arxiv.org/abs/2609.16528)
...
### [142] [AsyncCouple-Flow: Asynchronous Cross-Modal Coupling and Flow Matching for Spatio-Temporal Forecasting](https://arxiv.org/abs/2609.16573)
...
### [143] [Recovering Physical Parameters from Fragmented Observations via Exact Distributed Spline Merging](https://arxiv.org/abs/2609.16579)
*Naveen Mysore*
...
### [144] [A Weighted Kernel Method for Approximation that Adapts to Learned Multivariable Structure](https://arxiv.org/abs/2609.16606)
...
### [145] [Divergence Timing and Cumulative Disagreement under KV-Cache Eviction](https://arxiv.org/abs/2609.16617)
*Xinyue Luo,Fei Yu*
...
### [146] [Stable by Construction: Variational Latent Markov Operators for Long-Horizon PDE Prediction](https://arxiv.org/abs/2609.16621)
...
### [147] [GrowMTP: Can RL Grow Its Own Draft Head?](https://arxiv.org/abs/2609.16648)
...
### [148] [A Systematic Evaluation of Machine Learning Methods for Fault Detection and Line Identification in Electrical Power Grids](https://arxiv.org/abs/2609.16744)
...
### [149] [Noise2Noise Revisited: Training Pair Distributions Dominate Loss Choice in Self-Supervised Denoising](https://arxiv.org/abs/2609.16788)
...
### [150] [Geometry of learning dynamics: Gradient descent versus natural gradient on the ridge of optimization](https://arxiv.org/abs/2609.16805)
*Akira Tamamori*
...
### [151] [ImpossibleRubrics: Stress-Testing Generated Rubrics as Reward Signals](https://arxiv.org/abs/2609.16816)
...
### [152] [LCAP: Population-Informed Latent Chip Adaptation from Few Output Probes for Photonic Neural Networks](https://arxiv.org/abs/2609.16823)
...
### [153] [Adapting to Decision-Relevant Non-Stationarity in Decentralized Heterogeneous Bandits](https://arxiv.org/abs/2609.16824)
*Zhaojun Peng*
...
### [154] [Information Geometric Self-Organization at the Edge of Stability in High-Capacity Kernel Associative Memories](https://arxiv.org/abs/2609.16827)
*Akira Tamamori*
...
### [155] [Can Deep Learning Achieve Cross-Physics Mapping?](https://arxiv.org/abs/2609.16853)
...
### [156] [HyCoSeq: Contextual Hyperbolic Representation Learning for Genomic Sequences](https://arxiv.org/abs/2609.16925)
...
### [157] [CLARE: Scalable Class-Incremental Continual Learning via a Sparsity-Based Framework](https://arxiv.org/abs/2609.17026)
...
### [158] [Learning Options for Compositional Motor Control with Adapter Banks](https://arxiv.org/abs/2609.17042)
...
### [159] [High-Fidelity Digital Twin Data Models by Randomized Dynamic Mode Decomposition and Deep Learning with Applications in Fluid Dynamics](https://arxiv.org/abs/2609.17101)
*Diana A. Bistrian*
...
### [160] [Neural Field Ensembles for Aerodynamic Surface Prediction: Winning Solution to the ONERA CRM Wall Distribution 2025 Challenge](https://arxiv.org/abs/2609.17160)
...
### [161] [IRENE: A Convolutional GRU Ensemble Model for Radar Precipitation Nowcasting over Italy](https://arxiv.org/abs/2609.17175)
...
### [162] [LoopSpec: Pipelined Self-Speculative Decoding for Looped Transformers](https://arxiv.org/abs/2609.17184)
...
### [163] [MyoFlow: Anchor-Tied Rectified Flow for HD-sEMG Gesture Recognition Across Sessions and Subjects](https://arxiv.org/abs/2609.17194)
...
### [164] [Memorisation bias in medical AI](https://arxiv.org/abs/2609.17223)
...
### [165] [Personalized Federated Learning through Global Knowledge Distillation and Local Head Adaptation](https://arxiv.org/abs/2609.17284)
...
### [166] [Same Flow, Different Paths: Variance Reduction in Flow Matching](https://arxiv.org/abs/2609.17287)
*Alexander Tyurin*
...
### [167] [Hybrid Variational Quantum Circuits for Multivariate Regression and High-Dimensional Data Reconstruction](https://arxiv.org/abs/2609.17358)
...
### [170] [Bridging the Confidence Gap: Temperature Scaling for Calibrating Test-Time Prompt Tuning](https://arxiv.org/abs/2609.17386)
...
### [171] [Knowledge as Orbit: Finite Collections as Phases of an Exactly Periodic Latent Generator](https://arxiv.org/abs/2609.17417)
...
### [172] [Reduced-Space Multi-Fidelity Bayesian Optimization of Process Simulation Models](https://arxiv.org/abs/2609.17440)
...
### [173] [FreqSpaNet: Frequency and Spatial Learning of SFPF for Physical Layer Hardware Integrity Detection](https://arxiv.org/abs/2609.17491)
...
### [174] [How Can We Shrink the Family of Test Databases? Query Containment with Nulls and Comparisons](https://arxiv.org/abs/2609.16218)
...
### [175] [Scheduling Jobs with Multiple Operational Modes and Tail Times](https://arxiv.org/abs/2609.16001)
...
### [176] [SETH-based Lower Bound for Dynamic Degeneracy](https://arxiv.org/abs/2609.16303)
...
### [177] [A deterministic $(2 + \varepsilon)$-approximation for directed feedback vertex sets in tournaments](https://arxiv.org/abs/2609.16723)
...
### [178] [Improved Approximation for Unsplittable CVRP via a Greedy Approach](https://arxiv.org/abs/2609.16910)
...
### [179] [Improved Regular Expression Matching with Simple Backreferences](https://arxiv.org/abs/2609.16914)
...
### [180] [High-Multiplicity Bin Packing is FPT](https://arxiv.org/abs/2609.16923)
...
### [181] [Rank-One Matrix Discrepancy and Algorithmic Kadison--Singer](https://arxiv.org/abs/2609.17266)
...
### [182] [High Probability Streaming Lower Bounds for $F_2$ Estimation](https://arxiv.org/abs/2609.17286)
...
### [183] [Online Allocation using Few Samples](https://arxiv.org/abs/2609.17343)
...
### [184] [The Classical Weisfeiler-Leman Algorithm Stabilizes in $O(n)$ Rounds](https://arxiv.org/abs/2609.17364)
...
### [185] [PrecPack: An Efficient Open-Source Exact Solver for Bin Packing with Generalized Precedence Constraints](https://arxiv.org/abs/2609.17368)
...
### [186] [Pseudometric-Weighted Correlation Clustering via Spectral Preclustering](https://arxiv.org/abs/2609.17403)
...
### [187] [Determinant maximization subject to a partition matroid constraint via stable distributions](https://arxiv.org/abs/2609.17407)
...
### [188] [Stuffed IBLTs: Optimal Linear Multiset Sketches](https://arxiv.org/abs/2609.17487)
...
### [189] [Cognitive Admission Control: Risk-Conditioned Assurance for Consequential Actions in Agentic Distributed Systems](https://arxiv.org/abs/2609.16313)
*Jun He,Deying Yu*
...
### [190] [Novel Iterative Construction Methods for the Blocking Job Shop Scheduling Problem](https://arxiv.org/abs/2609.16007)
...
### [191] [Co-Skill: A Collaborative Communication Framework for Skill Evolution](https://arxiv.org/abs/2609.16008)
...
### [192] [Vectorization Of Narrow Matrix Multiplication for Ascend AI Inference Acceleration](https://arxiv.org/abs/2609.16009)
...
### [193] [BOA: Beamwidth Online Adaptation for Filtered-ANNS on a GPU](https://arxiv.org/abs/2609.16175)
...
### [194] [PipeSwift: Revisiting Pipeline Parallelism for Large-Scale Completion-Oriented Agentic Serving](https://arxiv.org/abs/2609.16491)
...
### [195] [XMPIaaS: Towards Cloud Native MPI via Cooperative Process Migration](https://arxiv.org/abs/2609.16531)
...
### [196] [DeepShare: Assurance-Driven Deep Learning Job Scheduling for Multi-Tenant Clusters](https://arxiv.org/abs/2609.16682)
...
### [197] [The Price of Random Access: Measuring Block Granularity Across Four Compressed Formats](https://arxiv.org/abs/2609.16731)
*Yakiv Shavidze*
...
### [198] [Nested Parallel von Neumann Architecture and Nested BSP](https://arxiv.org/abs/2609.16787)
*Heng Liao*
...
### [199] [Byzantine Reliable Broadcast with Causal Ordering](https://arxiv.org/abs/2609.17074)
...
### [200] [DS2-Based Cross-Data-Space Interoperability for Precision Agriculture](https://arxiv.org/abs/2609.17185)
...
### [201] [AI-Driven Feedback Systems, Digital Labour, and Silent Quitting: Transforming African Workplaces](https://arxiv.org/abs/2609.16192)
...
### [202] [Mapping U.S. Federal AI Governance Against Sector Vulnerability](https://arxiv.org/abs/2609.16260)
...
### [203] [Finding Common Mistakes In Modelling With Mathematical Formalisms Using LLMs](https://arxiv.org/abs/2609.17111)
...
### [204] [Measuring AI harms with multidimensional Lorenz Zonoids](https://arxiv.org/abs/2609.16004)
...
### [205] [Beyond Cultural Knowledge: Evaluating Arabic Cultural Appropriateness of Large Language Models](https://arxiv.org/abs/2609.16006)
...
### [206] [Using Codebooks to Detect Cybercrime Topics in Text Narratives](https://arxiv.org/abs/2609.16000)
...
### [207] [Do job seekers value procedure in AI hiring only for error correction? Evidence from a conjoint experiment](https://arxiv.org/abs/2609.16390)
...
### [208] [Silicon sampling answers with country-level assumptions, not individual attitudes: Cross-national evidence from the European Social Survey](https://arxiv.org/abs/2609.16395)
*Chuyao Wang*
...
### [209] [Dataset repurposing and disruptive AI research](https://arxiv.org/abs/2609.16736)
...
### [210] [AI literacy over tool design: a mixed-methods study of scaffolded versus unrestricted generative AI in programming education](https://arxiv.org/abs/2609.16784)
*Sepinoud Azimi*
...
### [211] [Evaluating Ambient Clinical Scribes in India: The Need for Multilingual Real-World Clinical Conversation Data](https://arxiv.org/abs/2609.17355)
...
### [212] [Balancing Trial and Reorder: A Hybrid Sequential Transformer-GBDT Ranker for On-Demand Delivery](https://arxiv.org/abs/2609.16407)
...
### [213] [AURA: Agentic Diagnosis and Refinement for Production Recommender Systems at Scale](https://arxiv.org/abs/2609.16625)
...
### [214] [Where Post-Training Quantization Breaks Text Embedders: A Measured Map Across Four Embedder Families](https://arxiv.org/abs/2609.16391)
*Hyojung Han*
...
### [215] [Evaluating Brand Retrieval and Ranking in Large Language Model Recommendations](https://arxiv.org/abs/2609.16304)
...
### [216] [PCap: Personalized Retrieval-Stage Diversity Capping in Facebook Marketplace](https://arxiv.org/abs/2609.16452)
...
### [217] [Predicting Partial Answer Quality and Utility in Agentic Retrieval-Augmented Generation](https://arxiv.org/abs/2609.16453)
...
### [218] [ReliGRec: Reliability-Oriented LLM-Based Generative Recommendation via User-Risk-Aware Prompt Routing](https://arxiv.org/abs/2609.16560)
...
### [219] [Measuring Decision-Scale Use in Tool-Augmented LLMs: A Contrastive Urban Benchmark](https://arxiv.org/abs/2609.16607)
...
### [220] [Efficient Swing Computation for Retrieval in Large-Scale Recommender Systems](https://arxiv.org/abs/2609.16850)
...
### [221] [Coaching Qwen3 Coder 30B to Think Like a CodeClash Arena Agent](https://arxiv.org/abs/2609.16096)
*Ivy Ning Zhang*
...
### [222] [Models as Governed Interfaces for AI-Native MBSE: Read-Side Adequacy and Write-Side Admissibility](https://arxiv.org/abs/2609.16252)
...
### [223] [Assurance Envelopes for Autonomous Coding Agents: Minimum-Cost Evidence for Software Change](https://arxiv.org/abs/2609.16302)
*Anjan Goswami*
...
### [224] [FairLint-DL: An IDE-Native Tool for Fairness Debugging of Deep Learning Software](https://arxiv.org/abs/2609.16321)
...
### [225] [Protocol-Preserving Context Trimming for Agentic Workflows: Benefits, Failure Regimes, and Budget Guardrails](https://arxiv.org/abs/2609.16461)
*Harish Gaggar*
...
### [226] [AI Policies: Help or Hindrance? A Software Developer's Perspective](https://arxiv.org/abs/2609.16496)
...
### [227] [RepoAtlas: Guiding Coding Agents via Evolving Multimodal Repository Views](https://arxiv.org/abs/2609.16936)
...
### [228] [Grounding SWE-Agent Decisions in Architecture-0 Design: Navigating Unknown Unknowns through Physical Mapping](https://arxiv.org/abs/2609.17221)
...
### [229] [After the Party: Governing What a Viral Agent-Skill Ecosystem Left Behind](https://arxiv.org/abs/2609.17274)
...
### [230] [Coding Agents Have Converged: Why the SWE-bench Leaderboard Can No Longer Order Its Top Entries, and What to Measure Instead](https://arxiv.org/abs/2609.17394)
...
### [231] [Docker Containers vs. Virtual Machines: A Comparative Study of Architecture, Performance, Configuration, and Security](https://arxiv.org/abs/2609.16148)
...
### [232] [AgentGuard: Learning Execution Guardrails from Anomalous Coding-Agent Trajectories](https://arxiv.org/abs/2609.16287)
...
### [233] [ExecuCritic: Calibrated Critic Shaping for Code Generation with Verifiable Rewards](https://arxiv.org/abs/2609.16604)
...
### [234] [An Exploratory Study of Dependabot Cooldown Adoption in Open-Source GitHub Projects](https://arxiv.org/abs/2609.16605)
...
### [235] [Memory-Skill Isomorphism: One Skill Carrier, Two Native Uses](https://arxiv.org/abs/2609.16669)
*Kang Ruiyuan*
...
### [236] [RECTIFY: An Interactive Workbench for Post-Evaluation RAG Diagnosis, Repair, and Verification](https://arxiv.org/abs/2609.16764)
...
### [237] [TasmScan: Continuation-Aware Taint Analysis for TVM Bytecode with Savelist Abstraction](https://arxiv.org/abs/2609.16987)
...
### [238] [Search-Based Metamorphic Testing of Vision-Language Models in Autonomous Underwater Robotic Software](https://arxiv.org/abs/2609.17007)
...
### [239] [GANADI: Uncovering C/C++ OSS Reuse Genealogies via Pivotal Function-Based Clustering to Enhance Supply Chain Security](https://arxiv.org/abs/2609.17018)
...
### [240] [A Set-Theoretic Evaluation Framework for Assessing Asset Administration Shell Instances: Towards Comparability and Suitability](https://arxiv.org/abs/2609.17062)
...
### [241] [Towards an Asset Administration Shell Maturity Model](https://arxiv.org/abs/2609.17084)
...
### [242] [A Memorization Floor for LLM Refinement of Decompiled Code](https://arxiv.org/abs/2609.17236)
*Muhammad Asjad*
...
### [243] [An Exemplar of a Digital Twin in Mechanical Engineering: Understanding Model Hybridization](https://arxiv.org/abs/2609.17258)
...
### [244] [Type-IV Code Clone Detection via Layer-Wise Non-Contrastive Representation Learning](https://arxiv.org/abs/2609.17338)
...
### [245] ["Looking for Something Weird to Happen": How Humans Sustain AI Agent Novelty Amid Semantic Collapse](https://arxiv.org/abs/2609.16051)
...
### [246] [Mo' Models, Mo' Problems: How to best select model pools when designing Multi-Agent Systems](https://arxiv.org/abs/2609.17306)
...
### [247] [Decomposition Buys Integrity, Not Yield](https://arxiv.org/abs/2609.17464)
*Rong He*
...
### [248] [Agentic Societies Need a Social Harness](https://arxiv.org/abs/2609.17527)
...
### [249] [Multi-Agent Learning with Cooperation-Driven Optimization Dynamics](https://arxiv.org/abs/2609.16917)
...
### [250] [Cheap Talk Stabilizes Strategic Interaction in LLM Agents](https://arxiv.org/abs/2609.16270)
...
### [251] [ToMAS: A Pilot Failure-Grounded Theory-of-Mind Benchmark from Multi-Agent LLM Failures](https://arxiv.org/abs/2609.16986)
...
### [252] [BeWater: Effective Protesters Navigate Watersheds in Street Networks](https://arxiv.org/abs/2609.17017)
...
### [253] [Calibrate Once, Fly Any Team: Residual-Grounded Low-Fidelity Training for Cooperative Drone Swarms](https://arxiv.org/abs/2609.17265)
...
### [254] [Emergence World: Adversarial Stress-Testing of Long-Horizon Multi-Agent Systems](https://arxiv.org/abs/2609.17320)
...
### [255] [Optimal Pruning for Neural Architectures using Fisher Information Distances](https://arxiv.org/abs/2609.16129)
...
### [256] [Safe Error Correction for Language Models: Frozen-Base Adjustment with Capability Preservation](https://arxiv.org/abs/2609.16145)
*Gautam Kishore*
...
### [257] [GPEvac: GNN-Based PPO for Adaptive Evacuation Routing During Shooting Events](https://arxiv.org/abs/2609.16163)
...
### [258] [Position: AI Is Not Ready for Strategic Conflicts](https://arxiv.org/abs/2609.16189)
...
### [259] [Calibrate, Then Route: A Measured Study of Learned Request Routing for Disaggregated LLM Serving](https://arxiv.org/abs/2609.16206)
...
### [260] [Artificial intelligence and biosecurity: capabilities, threat pathways, and defense-in-depth governance](https://arxiv.org/abs/2609.16213)
...
### [261] [Where Should the KV Cache Live? Placement Policies Across GPU, CPU, and SSD for Long-Lived Sessions](https://arxiv.org/abs/2609.16215)
*Srikanta Datta Tumkur,Jay Iyer,Mehar Simhadri,Sai Pavan Kumar,Sai Kapil Kumar,Ramesh Nampelly*
...
### [262] [Toward Governance-Aware Autonomous GIS: A Narrative Review of Ethical and Privacy Risks in LLM-Enabled GeoAI](https://arxiv.org/abs/2609.16232)
...
### [263] [Metacognitive Steering: Learning the Structure of Scientific Judgment](https://arxiv.org/abs/2609.16245)
...
### [264] [The Pain Axis: LLMs Represent Self-Directed Harm and Act to Relieve It](https://arxiv.org/abs/2609.16247)
...
### [265] [CADWorld: Computer-Use Benchmark for Long-Horizon Computer-Aided Design](https://arxiv.org/abs/2609.16251)
...
### [266] [The AI-Enabled Scientific Frontier](https://arxiv.org/abs/2609.16258)
...
### [267] [Closing the Loop: Branch-and-Bound for Scalable Verification of Nonlinear Neural Feedback Systems](https://arxiv.org/abs/2609.16298)
...
### [268] [CLEAR: Cross-Source Evidence Adjudication for Large Language Models in Medicine](https://arxiv.org/abs/2609.16301)
...
### [269] [BLINDSPOT: A Benchmark for Safety and Refusal Calibration in Long-Horizon Tool-Using Agents](https://arxiv.org/abs/2609.16305)
...
### [270] [Cross-Anatomy Transfer Versus Sparse Interpolation in Digital-Twin-Oriented Aortic Fluid-Structure Interaction Surrogates](https://arxiv.org/abs/2609.16322)
...
### [271] [Breaking the 1.58-bit Barrier for Ternary LLMs](https://arxiv.org/abs/2609.16338)
...
### [272] [Fine-Tuning Fixes Mode Collapse and Over-Dispersion in LLMs](https://arxiv.org/abs/2609.16454)
...
### [273] [Skill-based Agentic Evaluation for Real-time Data Science Tasks](https://arxiv.org/abs/2609.16487)
...
### [274] [From Manual Construction to AI-Driven Scenario Emergence: Rethinking Catastrophe Risk Modeling](https://arxiv.org/abs/2609.16493)
*Hang Gao*
...
### [275] [AquiLLM: Evaluating Faithfulness in Open-Weight RAG-LLM Systems for Scientific Research](https://arxiv.org/abs/2609.16519)
...
### [276] [QueryFormer: Winning Solution for KDD Cup 2026 Tencent UniRec Challenge](https://arxiv.org/abs/2609.16548)
...
### [277] [Query-Aware Source-Risk Triage for Retrieval-Augmented Generation](https://arxiv.org/abs/2609.16564)
...
### [278] [Do LLMs Have Values? A Quantitative Analysis and Alignment Framework for Values in Large Language Models](https://arxiv.org/abs/2609.16589)
...
### [279] [A Framework for Generating Valid Context-Specific Benchmarks through Expert Guidance](https://arxiv.org/abs/2609.16592)
...
### [280] [EchoPath: Execution-Level Replayable Memory for GUI Agents](https://arxiv.org/abs/2609.16635)
...
### [281] [ReDraft, Don't Just Distill: Reference-Driven Revision for Continual VLLM Post-Training](https://arxiv.org/abs/2609.16639)
...
### [282] [ANIMASK: What the Model Contributes to Role Play in Simulated Story Worlds](https://arxiv.org/abs/2609.16667)
...
### [283] [AI for Games in the Foundation Model Era](https://arxiv.org/abs/2609.16679)
...
### [284] [little m: An AI Agent for Industrial Process Optimization](https://arxiv.org/abs/2609.16680)
...
### [285] [VideoMM: Adaptive Macro-Micro Inference for Efficient Video MLLMs](https://arxiv.org/abs/2609.16722)
...
### [286] [LSREP: A Longitudinal State-Replay Protocol for Evaluating Conversational Memory, with ICE v2 as an Audited Local-First Architecture](https://arxiv.org/abs/2609.16730)
*Deepesh Sonar*
...
### [287] [Beyond Episodic AI: Cognitive Field Networks for Biologically Inspired Persistent Cognition](https://arxiv.org/abs/2609.16752)
*Byung Gyu Chae*
...
### [288] [Turn-level Multiscale Density Ratio Estimation for LLM Agents](https://arxiv.org/abs/2609.16760)
...
### [289] [Coverage-Aware Virtual IMU Augmentation for Low-Resource Human Activity Recognition](https://arxiv.org/abs/2609.16768)
...
### [290] [Integrating the Analytic Hierarchy Process with Large Language Models for Transparent Multi-Criteria Decision-Making](https://arxiv.org/abs/2609.16779)
...
### [291] [Layers, Sinks, and Scaling: Adaptive Evidence Selection for Multimodal Large Language Models](https://arxiv.org/abs/2609.16795)
...
### [292] [Can We Do Interpretable NLI with Graphs Based on Atomic Propositions?](https://arxiv.org/abs/2609.16814)
...
### [293] [Execution Flexibility in Automated Planning: A Comparative Evaluation of Deordering and Reordering Strategies](https://arxiv.org/abs/2609.16822)
...
### [294] [CoAdapt: An LLM-based Framework for Adaptive Collaborative Perception in IIoT Robotic Swarms](https://arxiv.org/abs/2609.16852)
...
### [295] [Bridging Learned Visual Perception and Symbolic Belief-Space Planning](https://arxiv.org/abs/2609.16884)
...
### [296] [QART: A Quantum-Classical Hybrid Architecture for Long-Horizon Reasoning -- Exploring a Conditional Path toward Quantum Scaling](https://arxiv.org/abs/2609.16887)
...
### [297] [AntennaFlow: A Generative Flow Model for Offset Correction in Phaseless Antenna Testing](https://arxiv.org/abs/2609.16948)
...
### [298] [Affect-Prototype Guided Fusion for Open-Vocabulary Incomplete Multi-modal Emotion Recognition](https://arxiv.org/abs/2609.16962)
...
### [299] [FlexEE: Self-Speculative and KV-Compatible Early Exiting for Offloading-Aware LLM Inference](https://arxiv.org/abs/2609.17008)
...
### [300] [ThinkFlow: Self-Evolving Probabilistic Latent Memory for Lifelong Conversational Agents](https://arxiv.org/abs/2609.17010)
...
### [301] [ORDER: Task-Conditioned Routing for Retrieval-Augmented Generation](https://arxiv.org/abs/2609.17012)
...
### [302] [SKIP: a Self-knowledge-guided Step-wise Preference Learning Framework for Concise Reasoning](https://arxiv.org/abs/2609.17019)
...
### [303] [Sparse MLLM Anchors, Dense Adaptation: Breaking the Self-Referential Loop in Wild Test-Time Adaptation](https://arxiv.org/abs/2609.17040)
...
### [304] [Neuro-Symbolic Hierarchical Intention Anticipation in Human Behavior](https://arxiv.org/abs/2609.17064)
...
### [305] [Sample-Conditioned Representation Selection for Audio Few-Shot Learning](https://arxiv.org/abs/2609.17076)
...
### [306] [Interactive Memory Learning for Long-Term Conversations](https://arxiv.org/abs/2609.17088)
...
### [307] [Scaling-Score Conformal Prediction for Multi-Target Regression](https://arxiv.org/abs/2609.17091)
...
### [308] [Semi-Supervised Learning-Based Genetic Biomarkers Dataset for Multiple-Stage Hepatocellular Carcinoma Prediction](https://arxiv.org/abs/2609.17100)
...
### [309] [Symbolic Separation: Grounding Deep Agents in Knowledge Graphs for Trustworthy Operational Data Analytics](https://arxiv.org/abs/2609.17107)
...
### [310] [Shared-Prefix KV Reuse Across Standard LoRA Adapters: Quality and Serving Tradeoffs](https://arxiv.org/abs/2609.17109)
*Dushyant Rajput*
...
### [311] [FirmCORe: A Benchmark for Structured Reasoning about Inter-Firm Collaboration Opportunities](https://arxiv.org/abs/2609.17128)
...
### [312] [MOCC-R1: Reinforcing Reasoning-Response Consistency for Multimodal Counselor Response Generation](https://arxiv.org/abs/2609.17180)
...
### [313] [End-to-End Latency-Minimizing and Load-Balanced Request Scheduling for Edge LLM Inference in Agentic AI Services](https://arxiv.org/abs/2609.17193)
...
### [314] [Extracting ontology-compliant knowledge from scientific text describing irradiated materials using large language models](https://arxiv.org/abs/2609.17291)
...
### [315] [Intrinsic Motivation in Reinforcement Learning: A Research Agenda for Adaptive Self-Organisation](https://arxiv.org/abs/2609.17325)
*Anatoly Belikov*
...
### [316] [From Transient Prompts to Persistent Control: Scientific Poster Generation via Recursive Semantic-Geometric Contracts](https://arxiv.org/abs/2609.17326)
...
### [317] [Self-Emergence Agent Architecture:Behavior-Inertia HMM, Reflexive Metacognition,and Social-Contrastive Self-Modeling](https://arxiv.org/abs/2609.17331)
*Xiaoyang Liu*
...
### [318] [FlashVector: Agent for Hierarchical Model Serving Stack Optimization](https://arxiv.org/abs/2609.17391)
...
### [319] [Never Stop Thinking: Continuous-Time Language Agents](https://arxiv.org/abs/2609.17416)
*Bojie Li,Noah Shi*
...
### [320] [World Model Science: Self-Organized Criticality, Weak Chaos, and Metastable Belief Dynamics in Long-Horizon LLM Agents](https://arxiv.org/abs/2609.17419)
...
### [321] [Transformer-Based Token Fusion and Dynamic Graph Planning for Audio-Visual Navigation](https://arxiv.org/abs/2609.17421)
...
### [322] [Talking Head Synthesis with Facial Landmark Guidance via 3D Gaussian Splatting](https://arxiv.org/abs/2609.17422)
...
### [323] [JustFit: 200K-Token LLM Serving on a 24 GiB Laptop with Just-in-Time State Management](https://arxiv.org/abs/2609.17475)
*Yuhua Chen*
...
### [324] [LimiX-2: A Contextual Mechanism Network Towards General Structured-Data Intelligence](https://arxiv.org/abs/2609.17488)
...
### [325] [Verifiable Social Reasoning for LLM Assistants](https://arxiv.org/abs/2609.17496)
...
### [326] [ScienceBuddy: Recursive-in-Recursive Self-Improvement for Interactive Scientific Agents](https://arxiv.org/abs/2609.17523)
