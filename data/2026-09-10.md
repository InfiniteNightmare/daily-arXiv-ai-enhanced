...
### [68] [Scores Alone Do Not Prove Discovery: The Discovery Certification Protocol for Auditing AI Research Agents](https://arxiv.org/abs/2609.09219)
...
### [69] [Who Are They to Each Other? Multi-Agent Reasoning for Speaker Relationship Inference](https://arxiv.org/abs/2609.09628)
...
### [70] [Glyph: A Multi-Strategy Agentic System for Column Description and Sensitivity-Ontology Tagging of Enterprise Data Catalogs](https://arxiv.org/abs/2609.10430)
...
### [71] [A Sharp Barrier for Consistent Submodular Maximization: Any Improvement over $2-\sqrt{2}$ Entails Exponential Queries or Linear Recourse](https://arxiv.org/abs/2609.09986)
...
### [72] [Approximate Nearest Neighbor in Ultra-High Dimensional $\ell_\infty$](https://arxiv.org/abs/2609.09427)
...
### [73] [Streaming Algorithms for Gaussian Kernel Density Statistics](https://arxiv.org/abs/2609.09622)
*Qin Zhang*
...
### [74] [Fast Algorithms for Sparse PCA and Robust Sparse Estimation](https://arxiv.org/abs/2609.09701)
...
### [75] [Minimum-makespan completion and vertex selection leave the Wang-Sitters constant at 11/6](https://arxiv.org/abs/2609.10004)
*Adam Y. Shavit*
...
### [76] [Optimal Non-Adaptive Vantage Point Selection](https://arxiv.org/abs/2609.10267)
...
### [77] [Testing the Binary Rank with Polynomial Query Complexity](https://arxiv.org/abs/2609.10496)
*Michal Parnas*
...
### [78] [Subexponential Approximation of the Permanent in Deterministic Polynomial Time](https://arxiv.org/abs/2609.10516)
...
### [79] [Violet: Enabling Full Virtualization for M-mode RTOS on RISC-V](https://arxiv.org/abs/2609.09833)
...
TL;DR: ContractEval 是一个用于评估 LLM 智能体是否遵循程序性指令的诊断框架。它将指令表示为查询条件下的活跃义务图(query-active obligations),并与响应或轨迹证据匹配,将遗漏、错误分支、顺序错误、多余操作、不变量违反和输出契约违反区分开来。在受控扰动基准测试中,纯输出型和轨迹感知型 LLM 评判者漏掉了许多结构性失败,而基于黄金图的 ContractEval 能检测并定位所有失败。


<details>
  <summary>Details</summary>
Motivation: 当 LLM 智能体从回答问题转向执行程序时,其失败往往是隐性的:最终响应看起来合理,但系统可能跳过了使该回答合理的检查、分支、依赖或不变量。纯输出评估只能看到答案,轨迹感知判断能看到活动,但两者都无法识别哪些义务对当前查询是活跃的。问题的核心在于缺少一个明确的标准——应当对哪些义务进行核对。

Method: ContractEval 采用四阶段流水线:(1) 静态契约编译——将指令解析为声明式层次任务网络(HTN);(2) 查询条件化——基于查询提取活跃义务,剪除非活跃分支;(3) 观察图提取——从响应或轨迹中构建已观察执行图;(4) 层次匹配——使用最大权二分图匹配对齐期望图与观察图。通过受控扰动协议(节点遗漏、分支违反、拓扑交换、多余动作、不变量违反、输出契约违反)评估评判者能力。

Result: 在 10 个 SOP 风格契约、200 个干净执行和 1400 个评估案例的基准测试上,纯输出型 LLM 评判者平均检测率仅 0.495、定位率 0.400;轨迹感知评判者达到 0.570 检测率和 0.468 定位率;最强轨迹感知评判者(GPT-5.4)仍漏掉 29.0% 的扰动案例。基于黄金期望和观察图的 ContractEval 实现了 1.000 的完美检测和定位。LLM 支持的提取保留大部分信号(GPT-4o 达 1.000/0.916,GPT-5.4 达 0.982/0.903),但观察图校准仍是可扩展性的主要瓶颈。

Conclusion: ContractEval 将程序性一致性从隐性评估转变为可审计的诊断。它将评估单位从答案级判断转变为查询活跃义务的证据,使遗漏、错误分支、不支持的操作和不变量违反可被检查。然而,它并非合规保证——其价值在于通过声明契约的审计到可扩展基准测试的分阶段路径,公开程序性评估的分母。声明契约在正确性重要时应保持审计,观察提取可在校准可接受时自动化。
...
### [134] [SCCM : Stream Cruise Control Method for Automated Drift Detection and Adaptation](https://arxiv.org/abs/2609.09432)
...
### [135] [Efficient Leakage-Free Neural Architecture Search under Leave-One-Subject-Out Evaluation](https://arxiv.org/abs/2609.09433)
*Heinke Hihn*
...
### [136] [From Fixed Keys to Readable Schemas: Small Language Models for Vehicle Agent Function Calls](https://arxiv.org/abs/2609.09476)
...
### [138] [Teacher Geometry Shapes Learnability in Teacher-Student Networks](https://arxiv.org/abs/2609.09595)
...
### [139] [Cascading Gradient Inversion via LT-Code Inspired Peeling in Federated Learning](https://arxiv.org/abs/2609.09659)
...
### [140] [Kernel-Complexity Edge Sanitization for Training-Free Defense against Structural Graph Attacks](https://arxiv.org/abs/2609.09698)
...
### [141] [Fine-Tuning a KV Cache Concatenation-Aware Model or Recomputing KV Caches? Why Not Both?](https://arxiv.org/abs/2609.09768)
...
### [142] [BRACE: Anchored Bellman-Residual Correction for Stale Critics in Asynchronous RL](https://arxiv.org/abs/2609.09783)
...
### [143] [Forward-Free LLM Depth Pruning via Weight Redundancy](https://arxiv.org/abs/2609.09883)
...
### [144] [Strangers to Themselves: What Language Models Say About Themselves Is Generic](https://arxiv.org/abs/2609.09899)
...
### [145] [MetroLLM-Bench: Evaluating Language Models as Transit Kiosk Runtimes](https://arxiv.org/abs/2609.10016)
*Remco Hendriks*
...
### [146] [A Trust-Network-Based Federated Learning Framework for Multi-Center Aging Clock Prediction](https://arxiv.org/abs/2609.10108)
...
### [161] [Tensor-Train Weak SINDy: Identifying High-Dimensional Nonlinear Dynamics](https://arxiv.org/abs/2609.09434)
...
### [162] [Uncertainty-Aware Sea-Ice Type Mapping with Multiple Ice Charts](https://arxiv.org/abs/2609.09451)
...
### [163] [Exact-Form Regret for Gradient Descent, Mirror Descent and Follow-the-Regularized-Leader](https://arxiv.org/abs/2609.09466)
...
### [164] [Building the Harness Automatically: Self-Play in Code Distills a Text Harness for Black-Box Optimization](https://arxiv.org/abs/2609.09468)
...
### [165] [Unthrottling the Tanh Jacobian in SAC: A Negative Result on Bang-Bang Control and MetaDrive](https://arxiv.org/abs/2609.09478)
*Faiq Shamass*
...
### [166] [Efficient Fairness Auditing Across Guidance Scales in Text-to-Image Diffusion Models via Causal Abstraction](https://arxiv.org/abs/2609.09486)
...
### [167] [Robust Industrial Cyber Physical Classification Using Neuromorphic Temporal Embeddings and Hybrid SNN XGBoost Under Machine Unlearning Attacks](https://arxiv.org/abs/2609.09564)
...
### [168] [Positional task conditioning for scalable defect detection across product families in large product catalogs](https://arxiv.org/abs/2609.09567)
...
### [169] [PELM: Power Efficient On-Device LLM Inference with Speculative Decoding and Dynamic Voltage Frequency Scaling](https://arxiv.org/abs/2609.09662)
...
### [170] [Muon-C: Operator-Aligned Muon for Convolutional Kernels](https://arxiv.org/abs/2609.09676)
...
### [171] [Settling: Equilibrium Inference for Non-Convex Validity Sets](https://arxiv.org/abs/2609.09682)
*Lyes Saad Saoud*
...
### [172] [ALIGN-HOLD: Experience Alignment for Real-Time Hold Control in Large-Scale Ride-Hailing Matching at DiDi](https://arxiv.org/abs/2609.09685)
...
### [173] [EFQ-Softmax: Exp-Free Quantization for Softmax](https://arxiv.org/abs/2609.09721)
...
### [174] [EEGBind: Detecting Source-Level Interictal Epileptiform Discharges via EEG-Centric Multimodal Binding](https://arxiv.org/abs/2609.09728)
...
### [175] [NEXUS-MI: Communication-Aware Federated Personalization for Gateway-Coordinated Motor-Imagery Brain-Computer Interfaces](https://arxiv.org/abs/2609.09786)
...
### [176] [Evaluating Model Retraining under Drift: Paired Comparisons of Cumulative Subgroup Disparity](https://arxiv.org/abs/2609.09788)
*Aaron Ceross*
...
### [177] [Privacy-Preserving Split Learning for Federated LLM Fine-Tuning](https://arxiv.org/abs/2609.09794)
...
### [178] [A practical DIRECT-type algorithm for medium-scale black-box global optimization](https://arxiv.org/abs/2609.09796)
...
### [179] [Online Inverse Integer Linear Optimization via Small-Gradient Skipping: Constant Regret and Finite Mistakes](https://arxiv.org/abs/2609.09809)
*Akira Kitaoka*
...
### [180] [In Medical Claims Data, Enhancing Predictive Performance for Major Adverse Cardiovascular Events Using Cross Attention](https://arxiv.org/abs/2609.09824)
...
### [181] [TempTPI: Informer-Based trajectory prediction for maritime vessels](https://arxiv.org/abs/2609.09840)
...
### [182] [Exact Degeneracy Under Balanced k-Shot Sampling:Consequences for Small-Sample Discriminant Analysis on LLM Embeddings](https://arxiv.org/abs/2609.09860)
*Lingxiao Qu*
...
### [183] [ProMeta: Few-shot PROTAC-targeted degradation prediction across E3 ligases](https://arxiv.org/abs/2609.09891)
...
### [184] [Beyond Conventional Federated Learning via High-Order Regularization](https://arxiv.org/abs/2609.09904)
...
### [185] [Meta-LinEXP3: Online-within-Online Learning for Adversarial Linear Contextual Bandits](https://arxiv.org/abs/2609.09907)
...
### [186] [A Kernel-Based Modular Discriminant Analysis Framework for Small-Sample Learning](https://arxiv.org/abs/2609.09910)
*Lingxiao Qu,Yan Pei*
...
### [187] [Development and Validation of a Physics-Guided Machine Learning Extrapolation Framework Using a Classical Transient Diffusion Benchmark](https://arxiv.org/abs/2609.09912)
...
### [188] [Multi-Pass, Multi-View Blended Learning for High-Fidelity Volumetric CT Synthesis from Chest X-Rays](https://arxiv.org/abs/2609.09920)
...
### [189] [Adversarial Training for Tabular Credit Scoring: A Multi-Attack Robustness Evaluation in P2P Lending](https://arxiv.org/abs/2609.09945)
*Gijs A. F. Niewzwaag,Marijn G. S. Veth,Manuele Massei,Marcos R. Machado*

Main category: cs.LG

TL;DR: 该论文针对P2P借贷信用评分场景，系统评估了对抗性训练在多种攻击下的鲁棒性。研究使用Lending Club大规模数据集，比较了三种模型（逻辑回归、前馈神经网络、表格Transformer）在四种对抗攻击（FGSM、PGD、Salt-and-Pepper、DeepFool）以及混合攻击训练下的表现。核心发现：对抗训练对训练所用攻击类型大幅提升鲁棒性，且在梯度类攻击间（FGSM与PGD）良好迁移，但向非梯度类攻击（S&P）迁移很弱；混合训练提供最均衡的鲁棒性且不牺牲干净测试性能。


<details>
  <summary>Details</summary>
Motivation: 现有对抗鲁棒性证据主要来自图像和文本领域，且多为单一攻击对应单一防御的评估，无法指导表格型信用数据中防御在不同攻击类型间的泛化能力。P2P借贷场景下申请人可能战略性篡改自报特征以获得有利决策，模型对此类操纵的韧性研究不足，且操作化攻击者不太可能局限于单一威胁模型，因此需要系统性多攻击压力测试。

Method: 基于CRISP-ML流程，对Lending Club约40万条贷款数据（含396,030观测、28个特征）进行预处理（缺失值处理、编码、Min-Max缩放）。评估三类模型：逻辑回归、前馈神经网络、FT-Transformer。使用五种训练配置（Clean、FGSM、PGD、S&P、DeepFool、混合）和五种测试条件构成完整网格，采用分层5折交叉验证。攻击约束于申请人可篡改特征（annual_inc、dti、revol_bal、revol_util、purpose、zip_code），通过梯度掩码和结构有效的一位有效编码交换实现。FGSM/PGD采用ε=0.1、PGD迭代40次步长0.01；DeepFool设置η=0.025、最大迭代100次；S&P腐蚀量0.1。训练时采用80%干净样本+20%对抗样本增强。在Prosper数据集上进行外部复制验证。

Result: 1）干净基线：三模型ROC AUC在0.903-0.906，准确率约0.82-0.83。2）干净模型受攻击后适度退化（ROC AUC降至0.855-0.878），无模型崩溃。3）匹配训练大幅提升鲁棒性：神经网络FGSM/PGD测试ROC AUC达0.952-0.959；Transformer达0.980。4）FGSM与PGD之间强迁移（结构相似），但梯度类训练对S&P迁移很弱。5）混合训练为最均衡方案：Transformer混合训练在干净测试0.825、FGSM/PGD测试0.865（ROC AUC 0.979）、DeepFool测试0.826，几乎匹配最佳单攻击训练，同时保持干净性能。6）Prosper数据集外部复制确认相同定性模式：梯度类攻击最破坏、匹配训练恢复判别力最强、FGSM/PGD互换、跨家族迁移弱、混合训练最均衡。7）管理启示：建议将多攻击压力测试纳入信用模型治理。

Conclusion: 对抗训练显著提升信用评分模型在匹配攻击下的鲁棒性，且对梯度类攻击家族内迁移良好，但对非梯度腐蚀迁移有限。单一攻击防御会高估真实世界韧性，因此推荐采用多攻击/混合训练作为默认策略，尤其对高容量模型而言可在不牺牲干净性能前提下增强异质攻击下的均衡鲁棒性。未来研究应发展约束感知的攻击方法、面向金融表格数据的黑盒攻击、分布漂移下的鲁棒性评估，并将鲁棒性纳入模型治理框架。
...
### [190] [Deep Neural Networks for Learning Intent from sEMG Signals to Support Hardware Devices for Post-Stroke Neurorehabilitation](https://arxiv.org/abs/2609.09971)
...
### [191] [An Explainable Machine Learning Framework for Predicting Blood-Brain Barrier Permeability Using Molecular Descriptors](https://arxiv.org/abs/2609.10012)
*Fatemeh Mahmoudi*
...
### [197] [Storage-Scalable Progressive Semantic Communication via Knowledge-Base Reuse](https://arxiv.org/abs/2609.10112)
...
### [198] [CompassOPD: Cross-Family On-Policy Distillation via Within-Family Likelihood Shifts](https://arxiv.org/abs/2609.10154)
...
### [199] [CoGe-GCD: Reframing Generalized Category Discovery with Compositional Generalization](https://arxiv.org/abs/2609.10158)
...
### [200] [An Exponential Deterministic--Randomized Gap in ERM-Oracle Complexity for Thresholds on an Unknown Order](https://arxiv.org/abs/2609.10196)
*Xuan Li*
...
### [201] [Robust Beam Prediction for V2X Networks with Multi-Modal Sensing](https://arxiv.org/abs/2609.10200)
...
### [202] [Training Trajectories Determine Circuit Removability in Annealable Soft-Prior Transformers](https://arxiv.org/abs/2609.10287)
...
### [203] [A Dominant Diffuse Phase in the Sparse Autoencoder Phase Diagram](https://arxiv.org/abs/2609.10299)
*Alexis D. Plascencia*
...
### [204] [View-Structured Conformal Prediction for 3D Gaussian Splatting](https://arxiv.org/abs/2609.10307)
...
### [205] [A Later Test Set Is Not a New Domain: Pretraining Familiarity Survives a Contamination-Free Hold-Out](https://arxiv.org/abs/2609.10357)
*Mahdi Naser Moghadasi,Faezeh Ghaderi*

Main category: cs.LG

TL;DR: 该论文指出时间序列基础模型（TSFM）评测中普遍存在数据污染问题：即便采用时间外推的"干净"测试集，仍无法排除模型因预训练语料与测试领域重叠而获得优势。作者构建了一个时间起点为2026年1月1日、覆盖5个领域7组数据的污染隔离评测协议，对比13种模型（4种经典方法、3种逐数据集训练、6种预训练模型）。结果发现：预训练模型在7组中赢5组，在电力领域输给Theta基线，在汇率上与所有方法无差异。预测精度差异无法用序列内在属性（季节性强度、谱熵）解释，而与预训练语料的领域重叠高度相关——TimesFM在维基百科页面浏览量上优势最大（28% MASE降低），且在该领域显著优于Chronos家族（p<10^-5）。结论是：时间隔离测试集无法消除领域熟悉度带来的偏差，基准测试需基于已披露的语料进行领域层面的隔离。


<details>
  <summary>Details</summary>
Motivation: 时间序列基础模型（Chronos、TimesFM、Moirai等）的零样本声称建立在公开发布的基准集上，而这些基准集早于模型发布且与其预训练语料同源，因此高分无法区分泛化能力与记忆效应。需要一种更严格的评测协议来揭示这一污染问题，并理解预训练模型在哪些条件下真正具有优势。

Method: 1. **污染隔离协议**：固定预测起点为2026年1月1日，所有测试观测均晚于所有评估模型的发布日期；评测6个预训练检查点（Chronos-Bolt small/base、Chronos-2、TimesFM 2.5/3.0、Moirai-2.0-R-small）。2. **数据来源**：5个领域7组数据——维基百科页面浏览量（每日/每周/每月）、天气（每小时）、空气质量（每小时）、电力（每小时）、汇率（每日）；全部来自可公开访问、无需API密钥的机构来源。3. **对比方法**：4种经典方法（SeasonalNaive、Theta、AutoETS、AutoARIMA）、3种逐数据集训练方法（LightGBM、LSTM、NBEATS）。4. **评估指标**：MASE、sMAPE、加权分位数损失、80%区间覆盖率；主要按Demšar平均秩加Nemenyi区间进行显著性比较，并以Holm校正的Wilcoxon符号秩检验辅助验证。5. **机理解释检验**：测量每组序列的STL季节性强度与差分谱熵，与预训练优势进行关联；并通过预训练模型家族内的同序列配对比较（TimesFM vs Chronos）隔离领域熟悉度效应。

Result: 1. **整体表现**：预训练模型在7组中赢5组；在电力（小时级）领域Theta排名第一；在汇率上所有13种方法无统计差异（含季节朴素）。2. **最优基线比较**：维基百科每日页面浏览量MASE最优降低25.8%，每周降低28.4%（TimesFM3）；天气/空气质量约+12%；电力-10.6%。3. **内在属性失败**：季节性强度与优势呈反向关联（维基百科季节性最弱却优势最大，天气季节性最强却优势中等），谱熵亦无法排序；两个属性均不解释梯度。4. **语料熟悉度效应**：在1500条维基百科序列上，TimesFM家族对Chronos家族的平均秩差为-0.53，其他领域（754条）仅为-0.09，Mann-Whitney p<10^-5，秩双列相关-0.13。5. **概率校准分裂**：所有预训练模型80%区间覆盖率系统低于标称值（最差Moirai2低9个百分点），三类自动经典方法系统高于标称值（Theta高9个百分点），按家族呈现干净分裂。6. **成本结构**：Chronos-Bolt-Small速度居首（0.0125秒/序列），AutoARIMA比其慢约308倍（长序列下可达2689倍）。7. **方法学发现**：单条接近常量的丹麦水电序列导致神经网络MASE均值偏离6个数量级，论证了基于秩的报告对单条退化序列的鲁棒性。

Conclusion: 时间隔离测试集消除了对观测的记忆，但无法消除对领域的熟悉。预训练模型在与其预训练语料重叠的领域（如TimesFM之于维基百科页面浏览量）所展现的优势，并非源于对这些具体观测的记忆，而是源于对该类序列统计规律的掌握。现有基准因高度依赖公开存档，恰好最有可能与预训练语料重合，因此单凭时间外推无法修复基准——必须按领域进行隔离，并依赖预训练语料的充分披露。对实践者而言，核心问题不是"哪个模型更好"，而是"我的数据是否落在该模型熟悉的领域"。
...
### [206] [Nonmaximal sums of maximally monotone operators under Rockafellar's constraint qualification](https://arxiv.org/abs/2609.10487)
*Weifeng Yang*
...
### [207] [Learning with Covariance Matrices: Principal Component Analysis Meets Learning with Graphs](https://arxiv.org/abs/2609.10490)
...
### [208] [Quantum Feature Engineering for Credit Default Prediction: When and Why IQP Circuits Help Linear Classifiers](https://arxiv.org/abs/2609.10505)
...
### [209] [A positive resolution of the gap-entropy conjecture](https://arxiv.org/abs/2609.10529)
...
### [210] [LiteRAG: Cost-Efficient Graph-Based Retrieval-Augmented Generation](https://arxiv.org/abs/2609.10239)
...
### [211] [Extracting Semantics from Cattle Reporting Categories for Data Interoperability and Findability](https://arxiv.org/abs/2609.09381)
...
### [212] [Should I Be Polite to My LLM Relevance Judge? Tone as a Severity Operating-Point Shift](https://arxiv.org/abs/2609.09703)
*Tian Zhang,Meng Li*
...
### [213] [Purchase Advice and Observable Buyer Responses in Real AI Conversations](https://arxiv.org/abs/2609.09878)
*Benjamin Tannenbaum*
...
### [214] [Guaranteeing Faithful Evidence Extraction in Speculative Retrieval-Augmented Generation](https://arxiv.org/abs/2609.10046)
...
### [215] [When Does Low-Bit Quantization Preserve the Decisions of Vector Search?](https://arxiv.org/abs/2609.09854)
*Wenxuan Xiao,Xu Cao*
...
### [216] [Contextual Utility of Quantization Moves in Extreme Low-Bit LLMs](https://arxiv.org/abs/2609.09867)
*Wenxuan Xiao,Xu Cao*
...
### [217] [Few Rows Tell Them Apart: Equivalence of Queries Mixing Set and Bag Semantics](https://arxiv.org/abs/2609.09978)
*Sara Cohen*
...
### [218] [Introducing Consort: A Spec-First Agent Framework for Enforced, Test-Driven Development on Live Database Branches](https://arxiv.org/abs/2609.09671)
*Kevin Hartman*
...
### [219] [Talking to Itself While Coding: What Makes Comments Help Code Generation?](https://arxiv.org/abs/2609.09242)
...
### [220] [The Vibe Shift in Software Engineering: Evaluating AI-Led Conversational Programming for Performance, Cognition, and Responsible Adoption](https://arxiv.org/abs/2609.09560)
...
### [221] [A-JIT: Agentic Just-In-Time Software Construction](https://arxiv.org/abs/2609.10248)
...
### [222] [OASIS: A Rubric-Based Multimodal Assessment Platform Using Large Language Models](https://arxiv.org/abs/2609.09180)
...
### [223] [Evaluating Enterprise Analytics Agents: An End-to-End, Trace-Backed Methodology](https://arxiv.org/abs/2609.09182)
...
### [224] [The Double Measurement Confound in Agent Benchmarks: De-Scaffolding, Ground-Truth Scoring, and Reliability Beyond the Mean](https://arxiv.org/abs/2609.09218)
...
### [225] [Cost-Aware Post-Hoc Deferral Under Calibration and Shift: An Environmental AI Case Study](https://arxiv.org/abs/2609.09235)
...
### [226] [How effective are traditional test criteria at detecting bugs in large language models generated code?](https://arxiv.org/abs/2609.09315)
...
### [227] [XAgent: eXecution-guided Agentic AI for Effective Localization and Resolution of GitHub Issues](https://arxiv.org/abs/2609.09769)
...
### [228] [Keep Evaluation Fair: Detecting Data Leakage in Code Generation Benchmarks via Membership Inference Attacks](https://arxiv.org/abs/2609.09865)
...
### [229] [Socio-technical and Ethical Dimensions of Architecture Practices in FLOSS](https://arxiv.org/abs/2609.09975)
*Sven Thielen*
...
### [230] [Beyond Repository Boundaries: Cross-Repository Graph Retrieval for Code Generation](https://arxiv.org/abs/2609.09987)
...
### [231] [GraphDroid: Asynchronous LLM-Based Mobile App GUI Testing via History-Aware Exploration and Hybrid Intent Fulfillment](https://arxiv.org/abs/2609.10031)
...
### [232] [If It's Not Buggy, Don't Fix It: On the Dynamics of Iterative Bug-fixing with LLMs](https://arxiv.org/abs/2609.10123)
...
### [233] [Ensembling LLMs for AI-Augmented Cybersecurity Software Requirements Generation](https://arxiv.org/abs/2609.10316)
...
### [234] [Retrofitting Code Using LLMs to Support Exceptional Behavior](https://arxiv.org/abs/2609.10397)
...
### [235] [Towards Scalable and Cost-Efficient Vulnerability Detection: A Study on Automatic Query Generation](https://arxiv.org/abs/2609.10412)
...
### [236] [Smart Adaptive Computing Across the Continuum: LLMs in IoT-Edge-Cloud Resource Management](https://arxiv.org/abs/2609.09348)
...
### [237] [LBFAST: A Lightweight Moment-Represented Lattice Boltzmann Solver for Multi-GPU Architectures](https://arxiv.org/abs/2609.09160)
...
### [238] [SMCC-Empowered Digital Twins for Sensorless Monitoring in Large-Scale AI-Driven IoT Systems](https://arxiv.org/abs/2609.09161)
*Vincenzo Sammartino*
...
### [239] [HELIOS: Guardrailed LLM-Driven Evolution of Autonomous Resource Orchestration Policies for Multi-Cloud Distributed Systems](https://arxiv.org/abs/2609.09164)
...
### [240] [TFR-GNN: Topology- and Fault-Aware Graph Neural Scheduling for Heterogeneous Distributed Computing Systems](https://arxiv.org/abs/2609.09165)
...
### [241] [Breaking Fault Lines: Unifying TEE-Assisted BFT Consensus in Partially Trusted Worlds](https://arxiv.org/abs/2609.09742)
...
### [242] [Epoch: Compiling Diffusion Blocks for Sparse MoE Serving](https://arxiv.org/abs/2609.09748)
...
### [243] [Introvert Clustering for Distributed Graph Algorithms](https://arxiv.org/abs/2609.10044)
...
### [244] [CEDD-optimizer: Enabling Cost-Efficient Dataset Distillation on Geographically Distributed Edge Systems](https://arxiv.org/abs/2609.10151)
...
### [245] [Stencil Computation at the Intersection of AI and HPC](https://arxiv.org/abs/2609.10368)
...
### [246] [Avatar: Toward Autonomous End-to-End Orchestration of Scientific Workflows using LLMs](https://arxiv.org/abs/2609.10509)
...
### [247] [Watermarks Without Verification: AI Text Watermarking After the EU AI Act](https://arxiv.org/abs/2609.09604)
...
### [248] [With a Thermomix You Lose the Ability to Cook: A Kitchen Machine Analogy for Applications of Generative AI in Education](https://arxiv.org/abs/2609.09856)
...
### [249] [Beyond Training: A Feasibility Taxonomy for Inference-Time AI Governance](https://arxiv.org/abs/2609.10105)
*Samar Ansari*
...
### [250] [Emergency Department Revisit Quality Review Screening: Exploring Human Decision-Making and Artificial Intelligence Support](https://arxiv.org/abs/2609.10421)
...
### [251] [Playing Whack-a-Mole with misconceptions about memorization, extraction, and copyright](https://arxiv.org/abs/2609.09320)
*A. Feder Cooper*
...
### [252] [Democracy Needs Reach: Political Equality, Online Speech, and Algorithmic Recommendation](https://arxiv.org/abs/2609.09465)
*Etienne Brown*
...
### [253] [Scalable Oversight for AI in Mental Health: Lessons from 350,000 AI Coaching Conversations between Therapy Sessions](https://arxiv.org/abs/2609.09533)
...
### [254] [Who You Are Adds Nothing Detectable to Where You Go Next: Sociodemographic Conditioning in LLM Next-Location Prediction](https://arxiv.org/abs/2609.09609)
...
### [255] [Senseful Consense: Towards Simplified Cookie Banners using Plain Language](https://arxiv.org/abs/2609.10271)
...
### [256] [Total Simulated Survey Error: Designing and Diagnosing Survey Responses from Large Language Models](https://arxiv.org/abs/2609.10280)
